...
<template>
  <header>
    <nav class="navbar navbar-expand-lg navbar-dark navbar-absolute bg-transparent shadow-none">
      <div class="container">
        <a class="navbar-brand text-white" href="/main">Trip Log</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbar-header-2">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item">
              <RouterLink class="nav-link text-white" :to="{ name: 'myPage' }">
                My Page
              </RouterLink>
            </li>
          </ul>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-7 d-flex justify-content-center flex-column">
            <h1 class="text-white mb-4">Trip Log</h1>
            <p class="text-white opacity-8 lead pe-5 me-5">
              친구들과 여행 계획을 세우고 여행을 기록하세요.
            </p>
            <div class="buttons">
              <RouterLink :to="{ name: 'signIn' }">
                <MaterialButton color="white" class="mt-4">Sign in</MaterialButton>
              </RouterLink>
