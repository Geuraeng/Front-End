          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-secondary shadow-secondary border-radius-lg py-3 pe-1">
          ...
          <div class="row align-items-center justify-content-lg-between">
            ...
            <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                ...
                <li class="nav-item">
                  <a href="https://github.com/Geuraeng" class="nav-link text-white" target="_blank"
                    >About Us</a
                  >
                </li>
                <li class="nav-item">
                  <a href="https://github.com/ch00me" class="nav-link text-white" target="_blank"
                    >YoungSeo GitHub</a
                  >
                </li>
                <li class="nav-item">
                  <a
                    href="https://github.com/tam31"
